...
# Design's atrributes
attributes = {"sign": '+', "PROC_SW": ["avr_sobel7"]}
generics = {}
...
_toVHDL.toVHDL("sobel_wrapper", attributes, generics, iosigs0, iosigs1, iosigs2, intrsigs0, intrsigs1, intrsigs2, intrsigs3, intrsigs4, intrsigs5, code)
