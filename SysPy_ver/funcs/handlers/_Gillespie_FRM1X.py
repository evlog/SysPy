...
def Gillespie_FRM1X(generics_func, func_param):
       """
       FUNCTION: Gillespie_FRM1X(a{}, b str)
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       _SBML_parser_SysPy.SBML_parser_SysPy(func_param[0], generics_func['K'], generics_func["Tsim"], '1', "FRM", generics_func["RNGseed1"])
