...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       hexFile = open("./proc_sw/" + CFile + ".hex", 'r')

       vhdFile_temp1 = open("./SysPy_comp_lib/ProcLib/AVRLib/XPM8Kx16_temp1.vhd", 'r')
       vhdFile_temp2 = open("./SysPy_comp_lib/ProcLib/AVRLib/XPM8Kx16_temp2.vhd", 'r')
       temp1 = vhdFile_temp1.read()
       temp2 = vhdFile_temp2.read()
       memFile = open("./proc_sw/XPM8Kx16.vhd", 'w')
       memFile.write(temp1)
