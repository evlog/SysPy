##def txt2BRAM(CFile):
##       """
##       FUNCTION: txt2BRAM(a str)
##              a: text file name string
##              
##       - Initalizing a "RAMB16_S36" block ram with the contentes of a text file.
##       """
##
...
vhdFile_temp1 = open("./spdisram10_temp1.vhd", 'r')
vhdFile_temp2 = open("./spdisram10_temp2.vhd", 'r')
temp1 = vhdFile_temp1.read()
temp2 = vhdFile_temp2.read()
memFile = open("./spdisram10.vhd", 'w')
memFile.write(temp1)
