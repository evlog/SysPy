...
signal gpioi, gpioi1, gpioi2, gpioi3 : gpio_in_type;
signal gpioo, gpioo1, gpioo2, gpioo3 : gpio_out_type;
...
----------------------------------------------------------------------
  ...
  gpio_0 : if CFG_GRGPIO_ENABLE /= 0 generate     -- GPIO unit
    grgpio0: grgpio
    generic map(pindex => 8, paddr => 8, imask => 16#FFFF#, nbits => 32)
...
--		gpioi.din(12 downto 0));
	...
	gpioi.din(31 downto 0) <= gpio_in;
	gpio_out <= gpioo.dout(31 downto 0);
	
  gpio_1 : if CFG_GRGPIO1_ENABLE /= 0 generate     -- GPIO unit
    grgpio1: grgpio
    generic map(pindex => 13, paddr => 13, imask => 16#FFFF#, nbits => 32)
...
--		gpioi1.din(12 downto 0));
	...
	gpioi1.din(31 downto 0) <= gpio1_in;
	gpio1_out <= gpioo1.dout(31 downto 0);
	
  gpio_2 : if CFG_GRGPIO2_ENABLE /= 0 generate     -- GPIO unit
    grgpio2: grgpio
    generic map(pindex => 14, paddr => 14, imask => 16#FFFF#, nbits => 32)
    port map(rst => rstn, clk => clkm, apbi => apbi, apbo => apbo(14),
...
--		gpioi1.din(12 downto 0));
	...
	gpioi2.din(31 downto 0) <= gpio2_in;
	gpio2_out <= gpioo2.dout(31 downto 0);
	
  gpio_3 : if CFG_GRGPIO3_ENABLE /= 0 generate     -- GPIO unit
    grgpio3: grgpio
    generic map(pindex => 12, paddr => 12, imask => 16#FFFF#, nbits => 32)
...
--		gpioi1.din(12 downto 0));
	...
	gpioi3.din(31 downto 0) <= gpio3_in;
	gpio3_out <= gpioo3.dout(31 downto 0);
