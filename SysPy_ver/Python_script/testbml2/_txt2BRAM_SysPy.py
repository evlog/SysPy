def txt2BRAM_func0(txtFile_name, M_reactions, N_species, num_proc, config_options):
       """
       FUNCTION: txt2BRAM_func0(a str, b int, c int, d int, e{})
              a: text file name string
              b: integer number of Spieces
              c: integer number of Reactions
              d: integer number of processors
              e: c: dictionary containing configuration file paths
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       if (num_proc == 1):
              vhdFile_temp1 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems0_temp1.vhd", 'r')
              vhdFile_temp2 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems0_temp2.vhd", 'r')
              temp1 = vhdFile_temp1.read()
              temp1 = temp1.replace("BRAM_size", str(BRAM_size - 1))
              temp2 = vhdFile_temp2.read()
              memFile = open(config_options["syspy_dir"] + "Python_script/paramsocs/LEONGILL/Lotka_VolteraparamRT.vhd", 'w')
              memFile.write(temp1)
       elif (num_proc == 2):
...
def txt2BRAM_func1(txtFile_name, M_reactions, N_species, config_options):
       """
       FUNCTION: txt2BRAM_func1(a str, b int, c int, d{})
              a: text file name string
              b: integer number of Spieces
              c: integer number of Reactions
              d: dictionary containing configuration file paths
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       vhdFile_temp1 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems1_temp1.vhd", 'r')
       vhdFile_temp2 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems1_temp2.vhd", 'r')
       temp1 = vhdFile_temp1.read()
       temp1 = temp1.replace("BRAM_size", str(BRAM_size - 1))
       temp2 = vhdFile_temp2.read()
       memFile = open(config_options["syspy_dir"] + "Python_script/paramsocs/LEONGILL/LOTKA_VOLTERA_STOICHIOparam.vhd", 'w')
       memFile.write(temp1)
...
def txt2BRAM_func2(txtFile_name, M_reactions, N_species, num_proc, config_options):
       """
       FUNCTION: txt2BRAM_func2(a str, b int, c int, d int, e{})
              a: text file name string
              b: integer number of Spieces
              c: integer number of Reactions
	       d: integer number of processors
              e: dictionary containing configuration file path
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       if (num_proc == 1):
              vhdFile_temp1 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems2_temp1_FRM1X.vhd", 'r')
              vhdFile_temp2 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems2_temp2_FRM1X.vhd", 'r')
              temp1 = vhdFile_temp1.read()
              temp1 = temp1.replace("BRAM_size", str(BRAM_size - 1))
              temp2 = vhdFile_temp2.read()
       ...
       if (num_proc == 1):
              memFile = open(config_options["syspy_dir"] + "Python_script/paramsocs/LEONGILL/speciesTable1.vhd", 'w')
              memFile.write(temp1)
       elif ((num_proc == 2) or (num_proc == 4)):
...
def txt2BRAM_func3(txtFile_name, M_reactions, N_species, config_options):
       """
       FUNCTION: txt2BRAM_func3(a str, b int, c int, d{})
              a: text file name string
              b: integer number of Spieces
              c: integer number of Reactions
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       vhdFile_temp1 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems3_temp1.vhd", 'r')
       vhdFile_temp2 = open(config_options["syspy_dir"] + "Python_script/testbml2/Initmems3_temp2.vhd", 'r')
       temp1 = vhdFile_temp1.read()
       temp1 = temp1.replace("BRAM_size", "511")
       temp2 = vhdFile_temp2.read()
       memFile = open(config_options["syspy_dir"] + "Python_script/paramsocs/LEONGILL/memintdimerLOTKA_VOLTERAparam.vhd", 'w')
       #memFile.write(temp1)
