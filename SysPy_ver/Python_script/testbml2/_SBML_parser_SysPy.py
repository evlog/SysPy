import sys, os
import struct
import _txt2BRAM_SysPy
import commands
import subprocess
from pdb import *

def SBML_parser_SysPy(XMLFile_name, gen_sim_mode, gen_sim_num, gen_num_proc, gen_algorithm, RNGseeds, config_options):
       """
       FUNCTION: SBML_parser_SysPy(a str, b str, c str, d str)
              a: dictionary containing function's generic values
              
       - Function generic's handler for "Gillespie_FRM1X".
       """
...
#for i in range(num_seed):
	...
	#	gen_seed = raw_input(msg).strip()
       ...
       if (XMLFile_name != ''):
              commands.getoutput("./parser_Sbmlmy_size " + XMLFile_name + ".xml")
              print "XMLFile_name:", XMLFile_name
              set_trace()
...
###################################################################################################################################
       ...
       txtFile_kparam = open(config_options["syspy_dir"] + "/Python_script/testbml2/" + file_name[0], 'r')
       ...
       txtFile_rtreactant = open(config_options["syspy_dir"] + "Python_script/testbml2/" + file_name[1], 'r')
       ...
       txtFile_rtproduct = open(config_options["syspy_dir"] + "/Python_script/testbml2/" + file_name[2], 'r')
       ...
       txtFile_RThex = open(config_options["syspy_dir"] + "Python_script/testbml2/RThex_values.txt", 'w')
       ...
       txtFile_vtreactant = open(config_options["syspy_dir"] + "Python_script/testbml2/" + file_name[3], 'r')
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       txtFile_vtproduct = open(config_options["syspy_dir"] + "Python_script/testbml2/" + file_name[4], 'r')
       ...
       txtFile_VThex = open(config_options["syspy_dir"] + "Python_script/testbml2/VThex_values.txt", 'w')
       ...
       txtFile_stparam = open(config_options["syspy_dir"] + "Python_script/testbml2/" + file_name[5], 'r')
       ...
       txtFile_SThex = open(config_options["syspy_dir"] + "Python_script/testbml2/SThex_values.txt", 'w')
...
#----------------------------------------------------------------------------------------------------------------------------------
       txtFile_fsize = open(config_options["syspy_dir"] + "Python_script/testbml2/" + file_name[6], 'r')
       ...
       txtFile_Gillespie_temp = open(config_options["syspy_dir"] + "Python_script/paramsocs/Leon3_comps_Gill_top/" + Gillespie_comp, 'r')
       ...
       #print "gen_seed_arr[i]:", gen_seed_arr[i]
       set_trace()
       x = x.replace("Sim_mode_value", str(gen_sim_mode))
       x = x.replace("Number_of_sims", str(gen_sim_num))

       for i in range(num_seed):
	       x = x.replace("RNGseed_val" + str((i)), str(gen_seed_arr))

       txtFile_Gillespie_temp.close()

       txtFile_Gillespie_temp = open(config_options["syspy_dir"] + "Python_script/paramsocs/LEONGILL/" + Gillespie_comp, 'w')
...
#----------------------------------------------------------------------------------------------------------------------------------
       ...
       OTFile = open(config_options["syspy_dir"] + "Python_script/testbml2/OT.txt", 'w')
       ...
       _txt2BRAM_SysPy.txt2BRAM_func0(config_options["syspy_dir"] + "Python_script/testbml2/RThex_values.txt", gen_reactions_BRAM, gen_species_BRAM, int(gen_num_proc), config_options)
       _txt2BRAM_SysPy.txt2BRAM_func1(config_options["syspy_dir"] + "Python_script/testbml2/VThex_values.txt", gen_reactions_BRAM, gen_species_BRAM, config_options)
       _txt2BRAM_SysPy.txt2BRAM_func2(config_options["syspy_dir"] + "Python_script/testbml2/SThex_values.txt", gen_reactions_BRAM, gen_species_BRAM, int(gen_num_proc), config_options)
       _txt2BRAM_SysPy.txt2BRAM_func3(config_options["syspy_dir"] + "Python_script/testbml2/OT.txt", gen_reactions, gen_species_BRAM, config_options)

       tclFile_temp = open(config_options["syspy_dir"] + "Python_script/testbml2/ISE_script_temp.tcl", 'r')
       tcl_temp = tclFile_temp.read()
       tclFile = open(config_options["syspy_dir"] + "Python_script/testbml2/ISE_script.tcl", 'w')
